...
const About = () => {
  return (
    <div className="max-w-7xl mt-[8rem] mx-auto flex flex-col ">
      <div className="">
        <p className="text-[#48AECD] uppercase text-sm font-bold mb-2">
          About us
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-10 mb-6">
        <div className="border    border-[#2E2E2E] rounded-2xl ">
          <div className="flex flex-col items-center py-[30px] px-0 text-center gap-2">
