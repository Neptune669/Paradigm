...
const About = () => {
  return (
    <div className="max-w-7xl mx-auto flex flex-col items-center lg:items-baseline lg:px-0 px-8">
      <p className="text-[#48AECD] uppercase text-sm font-semibold mb-2">
        About us
      </p>
      <div className="max-w-4xl">
        <div className="lg:text-4xl text-2xl  font-medium mb-10">
      ...
      <div className="grid lg:grid-cols-4 gap-10 mb-6 grid-cols-1">
