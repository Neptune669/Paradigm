...
export default function App() {
  ...
  return (
    ...
    >
      ...
      ></textarea>
      <label className="inline-flex items-center justify-center h-12 px-4 py-4 bg-white border border-white shadow lg:h-16 lg:px-8 lg:py-6 w-52 lg:w-60 rounded-3xl">
        <button
          type="submit"
